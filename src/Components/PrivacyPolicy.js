...
const PrivacyPolicy = () => (
    <div className="container">
        <h1>Privacy Policy for e car rental</h1>
        <p>At e car rental, accessible from https://ecarrenting.web.app/, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of information that is collected and recorded by e
            car rental and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in e car rental. This policy is not applicable to
        ...
        <h2>Log Files</h2>
        <p>e car rental follows a standard procedure of using log files. These files log visitors when they visit
            ...
            Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy
                Policy Generator</a> and the <a href="https://www.disclaimergenerator.org/">Disclaimer Generator</a>.
        </p>
        <h2>Cookies and Web Beacons</h2>
        <p>Like any other website, e car rental uses 'cookies'. These cookies are used to store information including
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of e car
            rental.</p>
        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on e car rental, which are sent directly to
        ...
        <p>Note that e car rental has no access to or control over these cookies that are used by third-party
            advertisers.</p>
        <h2>Third Party Privacy Policies</h2>
        <p>e car rental's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>e car rental does not knowingly collect any Personal Identifiable Information from children under the age of
